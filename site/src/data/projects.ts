...
export const projects: Project[] = [
  ...
  },
  {
    ...
    theme: 'blue',
    description:
      'Interactive short-video platform prototype with a vertical recommendation feed, trend discovery, creator tools, activity and profile experiences.',
    headline: 'Short-Video Social Experience',
    metric: '6 interactive product screens',
    stats: [
      ['6', 'Product screens'],
      ['5', 'Core navigation flows'],
      ['100%', 'Custom interface'],
      ['LIVE', 'Interactive prototype'],
    ],
    roles: ['Product Designer', 'Frontend Engineer', 'Design System Author'],
    timeline: [
      ['01', 'Product direction'],
      ['02', 'Mobile design system'],
      ['03', 'Feed and discovery'],
      ['04', 'Creator and profile flows'],
      ['LIVE', 'Interactive prototype'],
    ],
    delivered: [
      'Recommendation feed',
    ...
    challenges: [
      'Dense mobile interaction hierarchy',
      'Consistent dark and light surfaces',
      'Reusable short-video UI primitives',
      'Fast media-first rendering',
    ],
    outcomes: [
      'Complete interactive product concept',
      'Reusable mobile design system',
      'Five core navigation flows',
      'Portfolio-ready visual presentation',
    ],
    stack: ['React', 'Vite', 'JavaScript', 'CSS', 'Design System'],
    href: 'https://github.com/SHX-Developer/SHX-Loop',
    products: ['SHX-Loop Web App', 'Creator Tools', 'Discovery Feed'],
    monetization: ['Ads', 'Creator monetization', 'Premium effects'],
    tags: ['SHORT VIDEO', 'CREATORS', 'REACT', 'FEED'],
