...
const dictionaries = {
  en: {
    ...
    projects: {
      ...
      gallery: ['Interface', 'Product flow', 'System'] as const,
      stack: 'Stack',
    ...
    resume: {
      ...
      projectResumeText: 'Download the current one-page resume with selected products, stack, scale and contact details.',
      requestResume: 'DOWNLOAD PDF',
  ...
  ru: {
    ...
    projects: {
      ...
      overview: 'О проекте',
      gallery: ['Интерфейс', 'Продуктовый путь', 'Система'] as const,
      stack: 'Стек',
    ...
    resume: {
      ...
      projectResumeText: 'Скачай актуальное одностраничное резюме с проектами, стеком, масштабом и контактами.',
      requestResume: 'СКАЧАТЬ PDF',
